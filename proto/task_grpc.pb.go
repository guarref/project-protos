...
type TaskServiceClient interface {
	...
	DeleteTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *taskServiceClient) DeleteTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type TaskServiceServer interface {
	...
	DeleteTask(context.Context, *Task) (*empty.Empty, error)
...
func (UnimplementedTaskServiceServer) DeleteTask(context.Context, *Task) (*empty.Empty, error) {
